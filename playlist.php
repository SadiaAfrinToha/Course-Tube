   ...
   <div class="row">
      ...
      <div class="col">
         <form action="" method="post" class="save-list">
            ...
            ?>
               <button type="submit" name="save_list"><i class="far fa-bookmark" style="color: #888"></i><span>save playlist</span></button>
            <?php
               }
            ?>
         </form>
      ...
      <div class="col">
         <div class="tutor">
            ...
            <div>
               ...
               <span style="background-color: black; color: white;"><?= $fetch_tutor['profession']; ?></span>
            </div>
         </div>
         <div class="details">
            <h3><?= $fetch_playlist['title']; ?></h3>
            <span style="background-color: black; color: white;"><?= $fetch_playlist['date']; ?></span>
...
<section class="videos-container">
   ...
   <div class="box-container">
      ...
      <a href="watch_video.php?get_id=<?= $fetch_content['id']; ?>" class="box">
         ...
         <img src="uploaded_files/<?= $fetch_content['thumb']; ?>" alt="" style="background-color: white;">
